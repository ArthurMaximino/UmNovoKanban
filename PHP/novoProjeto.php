...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/novoProjeto.css">
                ...
                <div class="card-body text-dark">
                    <div align="center">
                        <div class="table-responsive">
                            <form id="Formulario" action="validaProjeto.php" method="POST">
                                <div class="form-group">
                                    <table id="Tabela">
                                        ...
                                        <tr>
                                        <td>
                                            <p id="corpo">Nome do projeto</p>
                                        </td>
                                        <td>
                                        <p id="corpo"><input type="text" name="nomeProjeto" class="form-control" placeholder="Insira o nome do projeto" id="verificaCampo"></p>
                                        </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <input type="submit" value="Criar" class="btn btn-outline-dark btn-block" name="Criar Projeto" id="validaBotao">
                                            </td>
                                        </tr>
                                    </table>
                                </div>
...
<script src ="../Javascript/novoProjeto.js"></script>
</html>