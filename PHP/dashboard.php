...
<div class="card text-white" id="barraLateral" style="font-weight: bold;">
    ...
    <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay">
            ...
            <div class="card border-dark mb-3" style="max-width: 30rem;" id="borderCard">
                        ...
                        <div class="table-responsive">
                                <div class="form-group">
                                    <table id="Tabela">
                                        <tr>
                                            <td>
                                                <h3>Boas-vindas ao CardTasker!</h3>
                                            </td>
                                        </tr>
                                        <tr>
                                        <td>
                                            <p id="textoinformativo">Número de projetos: <?php 
                //session_start();
                $nome_servidor = "localhost";
                $nome_usuario = "root";
                $senha = "";
                ...
                $email = $_SESSION['email'];
                $senha = $_SESSION['senha'];
                $sql= mysqli_query($conecta, "select count(id_projeto) as total from projeto where email_usr='$email'"); 
 ...
 echo $exibir["total"];
                ?></p>
                                        ...
                                        <tr>
                                            <td>
                                                <p id="icone">Crie um novo projeto selecionando o ícone à esquerda.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
