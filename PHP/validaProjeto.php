...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/validaProjeto.css">
                    ...
                    <div align="center">
                        <div class="table-responsive">
                                <div class="form-group">
                                    ...
                                    $novaQuery = mysqli_query($conecta, "SELECT * FROM projeto WHERE nome_projeto = '$nome_projeto'");
                                    if (mysqli_num_rows($novaQuery)>0)
                                    {
                                        header('location:erroNovoProjeto.php');
                                    }
                                    else
                                    {
                                    ...
                                    <tr>
                                        <td>
                                                <button onclick="window.location.href ='novoProjeto.php'" class="btn btn-outline-dark btn-block" id="Botao">Criar novo projeto</button>
                                        </td>
                                    </tr>
                                    </table>
                                </div>
